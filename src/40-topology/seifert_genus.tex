...
% kawauchi: Since any canonical Seifert surface is a free Seifert surface, we have the inequality 9c(K) ;::: 9j(K) ;::: g(K) for all knots K. For example, when K is an alternating knot (cf. 8.4.11), it is known that this inequality is replaced by the equality (cf. [Murasugi 1960]).
