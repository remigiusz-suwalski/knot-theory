...
Kawauchi \cite[s. 73]{kawauchi96} proponuje jako proste ćwiczenie  pokazanie, że grupa sumy niespójnej splotów $L_1, L_2$ jest izomorficzna z wolnym produktem $\pi(L_1) * \pi(L_2)$, a następnie przytacza twierdzenie:
...
\begin{proof}[Niedowód]
    Jest to wniosek 3 z~pracy \cite{feustel78} Feustela.
\end{proof}
% nie wiem gdzie: objętość jest wyznaczona przez grupę podstawową? recenzja 648524

\input{40-topology/401a-wirtinger}

\input{40-topology/401b-fox}
