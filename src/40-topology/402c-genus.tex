...
\index{człowiek!Nakamura, Takuji}%
\index{człowiek!Tripp, ?}%
precli (Brittenham, Jensen \cite{brittenham06}).
\index{człowiek!Brittenham, ?}%
\index{człowiek!Jensen, ?}%
\index{precel}%
