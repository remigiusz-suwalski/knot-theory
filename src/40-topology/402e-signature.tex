...
Pochodzi prawdopodobnie z lat sześdziesiątych (Trotter \cite{trotter62} dla węzłów, Murasugi \cite{murasugi65} dla splotów).
...
\begin{proof}
    ...
    Pomysł jest opisany dokładniej jako trzecie spostrzeżenie w~\cite{giller82} oparte o~\cite[twierdzenie 5.6]{murasugi65}.
\end{proof}
...
\begin{proof}
    Aneks w \cite{liechti16}, sama praca nie wygląda na związaną z~teorią węzłów.
\end{proof}
