...
\begin{figure}[H]
\centering
\includegraphics[width=0.40\linewidth]{../data/mixed/gauss_code.png}
\caption{Węzeł o kodzie 1 -2 3 -4 5 6 -7 -8 4 -9 2 -10 8 11 -6 -1 10 -3 9 -5 -11 7. Źródło: \url{https://knotinfo.math.indiana.edu/descriptions/gauss_notation.html}}
\end{figure}
...
Porządek jest umowny i jego wybór należy do osoby, która jako pierwsza znajdzie wszystkie węzły o danej liczbie skrzyżowań (przy czym węzeł skręcony występuje zawsze po torusowym).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.40\linewidth]{../data/mixed/dowker_code.png}
\caption{Węzeł o kodzie (DT) 16 18 20 -22 4 2 8 -6 12 10 -14. Źródło:\\ \url{https://knotinfo.math.indiana.edu/descriptions/dt_notation.html}}
\end{figure}
