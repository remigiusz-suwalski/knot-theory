...
\index[persons]{Prasołow, ?}%
\index[persons]{Sosiński, ?}%
\index[persons]{Zieschang, ?}%
...
\index[persons]{Budney, ?}%
\index[persons]{Pettersson, ?}%
...
\index[persons]{Petronio, ?}%
\index[persons]{Zanellati, ?}%
