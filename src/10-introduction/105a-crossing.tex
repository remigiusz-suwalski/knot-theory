...
Thistlethwaite rozszerzył wynik do tak zwanych węzłów adekwatnych: sam \cite{thistlethwaite88} albo razem z Lickorishem \cite{lickorish88} (tak przynajmniej sugeruje Malyutin \cite[s. 3]{malyutin16}, nie widzę tego).
