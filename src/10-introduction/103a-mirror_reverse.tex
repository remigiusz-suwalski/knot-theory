...
Przypuszczał to już Listing w 1847 roku \cite{listing1847}, ale pierwszy dowód podał dużo później, bo w 1914 roku Dehn \cite{dehn14}. 
...
\index[persons]{Whitten, Wilbur}%
    Stosowne przykłady podali niezależnie od siebie Hartley \cite[s. 183]{hartley80} oraz Whitten \cite{whitten81}.
\end{proof}
