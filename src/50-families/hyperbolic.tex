...
\index{reprezentacja paraboliczna}
...
\begin{proposition}
    Wśród orientowalnych 3-rozmaitości z ostrzem\footnote{cusped manifold -- niezwarte, zupełne hiperboliczne rozmaitości ze skończoną objętością Riemanna} najmniejszą objętość posiada dopełnienie ósemki oraz jej bliźniak, otrzymany przez $(5, 1)$-chirurgię jednego z~ogniw splotu Whiteheada.
...
% tak - https://arxiv.org/pdf/1203.6551.pdf mówi, że cao-meyerhoff znali obydwa węzły/sploty
% aczkolwiek nie mam pojęcia skąd to wziąłem

% Gabai-Meyerhoff-Milley [21] determined the first 10 low volume orientable cusped hyperbolic 3-manifolds. This shows that the next 4 limit volumes are:
...
\begin{proposition}
    Wśród orientowalnych 3-rozmaitości o~czterech ostrzach najmniejszą objętość posiada dopełnienie splotu $8_4^2$.
\end{proposition}
