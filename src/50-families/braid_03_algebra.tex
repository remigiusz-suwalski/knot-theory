...
Przez długi czas był to problem otwarty, potem Krammer \cite{krammer00} pokazał, że $B_4$ jest liniowa, następnie metodami topologicznymi Bigelow \cite{bigelow01} dowiódł, że liniowe są wszystkie grupy $B_n$, a~wkrótce po tym Krammer \cite{krammer02} uogólnił swoje algebraiczne rozumowanie też do wszystkich grup $B_n$.
