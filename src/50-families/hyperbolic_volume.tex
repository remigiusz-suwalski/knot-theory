...
\begin{proof}[Niedowód]
    Zdaniem angielskiej Wikipedii, dowód jest gdzieś w~\cite{neumann85} (gdzie Neumann, Zagier znajdują eleganckie oszacowanie zmiany objętości po wykonaniu chirurgii Dehna), ja tego nie widzę.
...
\index[persons]{Masai, Hidetoshi}%
    ...
    Jeszcze jedną wzmiankę znalazłem w \cite[s. 365]{thurston82}, starszej pracy Thurstona.
\end{proof}

W dowolnej rodzinie węzłów istnieje element o~najmniejszej objętości.
Przytoczę teraz przykłady konkretnych rodzin i~najmniejszych węzłów, za Futerem, Kalfagianni, Purcell \cite[s. 16-17]{purcell19} oraz Hodgsonem, Masaiem \cite[s. 1-99]{hodgson13}.
\index[persons]{Futer, David}%
\index[persons]{Kalfagianni, Efstratia}%
\index[persons]{Purcell, Jessica}%
\index[persons]{Hodgson, Craig}%
...
\index[persons]{Fomenko, Matwiejew}%
...
\index[persons]{Agol, Ian}%
    Agol \cite{agol10} korzystając z~metod topologicznych dowodzi istnienia ,,niezbędnej''\footnote{z angielskiego essential} powierzchni, która zadaje dolne ograniczenie na objętość i skutecznie krępuje rozmaitości, które mogą to ograniczenie zrealizować.
\end{proof}
