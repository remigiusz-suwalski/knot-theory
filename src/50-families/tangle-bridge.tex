...
% złożony => satelitarny
% niesatelitarny => pierwszy
% ale nie ma implikacji:
% pierwszy => niesatelitarny!
    ...
    Teza wynika wtedy bezpośrednio z faktu \ref{prp:torus_bridge_number}, który głosi, że $\bridge (T_{p, q}) = \min\{|p|, |q|\}$.
\end{proof}
