...
\index[persons]{Bohnenblus, ?}%
\index[persons]{Chow, ?}%
\index[persons]{Fadell, ?}%
\index[persons]{Fox, Ralph}%
\index[persons]{Magnus, ?}%
\index[persons]{Neuwirth, Lee}%
\index[persons]{van Buskirk, ?}%
...
\index[persons]{Fadell, ?}%
\index[persons]{Neuwirth, ?}%
\index[persons]{Garside, ?}%
\index[persons]{Dyer, ?}%
