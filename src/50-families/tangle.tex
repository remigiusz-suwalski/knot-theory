...
\index{człowiek!Janiak-Osajca, Agnieszka}%
\index{człowiek!Pogoda, Zdzisław}%
...
Patrz też \cite[s. 29-30]{duzhin12} (Chmutow, Dużin, Mostovoy przygotowali tam śliczne rysunki) albo \cite[s. 31]{schieber18}, gdzie Schieber przedstawił wariant z~ruchami Reidemeistera i~ciętymi diagramami.
\index{człowiek!Chmutov, Sergei}%
\index{człowiek!Duzhin, Sergei}%
\index{człowiek!Mostovoy, Jacob}%
\index{człowiek!Schieber, Nathaniel}%
% sliced diagrams
