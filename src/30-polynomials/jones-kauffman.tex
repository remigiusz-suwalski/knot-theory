...
Trzeci aksjomat jest wariacją na temat relacji kłębiastej.
...
\begin{proof}
    Szkic: W każdym kroku możemy albo zmniejszyć liczbę ogniw (drugi aksjomat), albo liczbę skrzyżowań (trzeci aksjomat).
