...
Niedawno Stoimenowi \cite{stoimenowa02} udało się udowodnić, że licząc wartość wielomianu $Q$ w~innym ustalonym punkcie nie można dowiedzieć się więcej o~homologiach modulo $p$.

Miyazawa \cite{miyazawa19} znalazł nieskończenie wiele węzłów i splotów o trywialnych wielomianach $Q$ (BLM/Ho) oraz $\conway$ (Conwaya), ale różnych wielomianach HOMFLY-PT.
