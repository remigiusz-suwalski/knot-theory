...
\index{przesmyk}%
\label{def:isthmus}%
    Wąskie skrzyżowanie między dwiema rozłącznymi częśćmi diagramu nazywamy przesmykiem.
\begin{comment}
    \[
...
\begin{conjecture}[Taita, pierwsza]
    ...
    Zredukowany, spójny, alternujący diagram zorientowanego splotu $L$ realizuje jego indeks skrzyżowaniowy.
\end{conjecture}
