...
\index[persons]{Polyak, Michael}% Михаил Поляк?
...
\begin{proof}
    Czmutow \cite{chmutov12} porównał ze sobą relację kłębiastą dla wielomianu Conwaya oraz dla niezmienników Wasiljewa.
...
\index[persons]{Czmutow, Siergiej}%
    ...
    Dokonał tego Bar-Natan \cite{barnatan91} jeszcze w latach dziewięćdziesiątych ubiegłego wieku.
